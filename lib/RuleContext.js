...
class RuleContext {
    ...
    get sourceCode() {
        if (!this._sourceCode) {
            this._sourceCode = new SourceCode_1.default(this.sourcePath, FS.readFileSync(this.sourcePath).toString());
        }
        return this._sourceCode;
    }
    get sourceTree() {
        if (!this._sourceTree) {
            this._sourceTree = new SourceTree_1.default(this.sourcePath, FS.readFileSync(this.sourcePath).toString());
        }
     ...
     *
     * */
    prepareReport(position, message, fix) {
